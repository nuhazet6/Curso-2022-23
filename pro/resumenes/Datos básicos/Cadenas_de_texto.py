...
saludo2[:-2]  # En el caso de poner string[::-1] obtenemos el inverso del string
...
# F-STRINGS f'Texto{variable} más texto{entero:03d} {decimal:010.02f}' tipos de datos: entero -> :d binario -> :b octal -> :o hexadecimal -> :x decimal -> :f notación científica -> :e  ; f'{columna_izquierda:<s}|{columna_central^11s}|{columna_derecha>7s}' se pueden usar las flechas <>^ para alinear el contenido a la izquierda, derecha o al centro.
rocket_code = 0x1F680
