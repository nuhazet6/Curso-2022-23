...
class Date:
    def __init__(self, day: int, month: int, year: int):
        ...
        """
        self.year = year if FIRST_YEAR_VALID < year < LAST_YEAR_VALID else FIRST_YEAR_VALID
    ...
    def delta_days(self) -> int:
        ...
        total_days += self.day -1 #Se tiene que restar 1 porque si no se contaría a sí mismo y tendríamos un día de más
        return total_days
